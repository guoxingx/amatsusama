 ...
 public:
    ...
    */
    ...
    /**
        ...
        \review 20190402
    */
    virtual bool HasFeature(const NeoString& name);
    ...
    */
    virtual bool IsReadable(const NeoString& name);
    ...
    /**
        ...
        \exception  FeatureAccessException The calling object is not valid
    */
    virtual bool IsWritable(const NeoString& name);
    ...
    */
    ...
    /**
        ...
        refer to the section \ref Images_and_buffers to learn how to configure the buffer-handling to change that
        behavior.
    ...
    */
    ...
    /**
        ...
        \warning    Calling this method will destroy all externally provided image buffers which might be
                    in use already!

        \param[in]  buffercount Image buffer count, if set to zero buffercount will be set to the default of 10 buffers
        \return     The CamBase object
        \see        \ref Images_and_buffers
        \review 20190402
    */
    ...
    */
    ...
    /**
        ...
        can be configured. Please see @ref basic_concepts for details
