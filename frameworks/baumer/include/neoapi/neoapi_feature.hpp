...
class NEOAPI_CPP_DECL Feature {
 public:
    ...
    */
    ...
    /**
        \brief      Get vendor specific data from the XML definition of this Feature object
        \return     Vendor specific data
        \exception  FeatureAccessException The calling object is not valid
    */
    virtual NeoString GetExtension() const;
...
class NEOAPI_CPP_DECL FeatureList {
 public:
    ...
    */
    ...
    /**
        \brief      The "=" operator is removed to ensure lists of features are not copied as the return of references would lead to unexpected behaviour

        \param[in]  object A FeatureList object
        \return     The FeatureList object
        */
    virtual FeatureList& operator = (const FeatureList& object) = delete;
