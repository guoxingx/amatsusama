...
enum class CalibrationMatrixValueSelector {
    Gain00 = 0,  //!< Gain 0,0 of the calibration matrix.
...
enum class OpticControllerStatus {
    Error = 0,  //!< The optic controller encountered an error.
...
enum class boSerialMode {
    Bypass = 0,  //!< Bypass mode. Rear Connector and Front Connector are connected.
...
enum class boSerialSelector {
    FrontConnector = 0,  //!< Selects the Front Connector.
    RearConnector  //!< Selects the Rear Connector.
};
...
class NEOAPI_CPP_DECL FeatureAccess {
 public:
    ...
    */
    ...
    /**
        \brief      Selects the gain factor of the calibration matrix.
    */
    ...
    */
    ...
    /**
        \brief      Enables or Disables the Concatenation FIFO Mode.
    */
    IntegerFeature EnableConcatenationFIFO;
    /**
    ...
    */
    ...
    /**
        \brief      EventConcatAvailableSensor1Timestamp
    */
    IntegerFeature EventConcatAvailableSensor1;
    /**
        \brief      Returns the Timestamp of the Concat Available Sensor 1 Event.
    */
    IntegerFeature EventConcatAvailableSensor1Timestamp;
    /**
        \brief      EventConcatAvailableSensor2Timestamp
    */
    IntegerFeature EventConcatAvailableSensor2;
    /**
        \brief      Returns the Timestamp of the Concat Available Sensor 2 Event.
    */
    IntegerFeature EventConcatAvailableSensor2Timestamp;
    /**
        \brief      EventConcatEmptySensor1Timestamp
    */
    IntegerFeature EventConcatEmptySensor1;
    /**
        \brief      Returns the Timestamp of the Concat Empty Sensor 1 Event.
    */
    IntegerFeature EventConcatEmptySensor1Timestamp;
    /**
        \brief      EventConcatEmptySensor2Timestamp
    */
    IntegerFeature EventConcatEmptySensor2;
    /**
        \brief      Returns the Timestamp of the Concat Empty Sensor 2 Event.
    */
    IntegerFeature EventConcatEmptySensor2Timestamp;
    /**
        \brief      EventExposureEndSensor1Timestamp
    */
    IntegerFeature EventExposureEndSensor1;
    /**
        \brief      Returns the Timestamp of the Exposure End Sensor 1 Event. It can be used to determine precisely when the event occured.
    */
    IntegerFeature EventExposureEndSensor1Timestamp;
    /**
        \brief      EventExposureEndSensor2Timestamp
    */
    IntegerFeature EventExposureEndSensor2;
    /**
        \brief      Returns the Timestamp of the Exposure End Sensor 2 Event. It can be used to determine precisely when the event occured.
    */
    IntegerFeature EventExposureEndSensor2Timestamp;
    /**
        \brief      EventExposureStartSensor1Timestamp
    */
    IntegerFeature EventExposureStartSensor1;
    /**
        \brief      Returns the Timestamp of the Exposure Start Sensor 1 Event.
    */
    IntegerFeature EventExposureStartSensor1Timestamp;
    /**
        \brief      EventExposureStartSensor2Timestamp
    */
    IntegerFeature EventExposureStartSensor2;
    /**
        \brief      Returns the Timestamp of the Exposure Start Sensor 2 Event.
    */
    IntegerFeature EventExposureStartSensor2Timestamp;
    /**
        \brief      EventFrameEndSensor1Timestamp
    */
    IntegerFeature EventFrameEndSensor1;
    /**
        \brief      Returns the Timestamp of the Frame End Sensor 1 Event.
    */
    IntegerFeature EventFrameEndSensor1Timestamp;
    /**
        \brief      EventFrameEndSensor2Timestamp
    */
    IntegerFeature EventFrameEndSensor2;
    /**
        \brief      Returns the Timestamp of the Frame End Sensor 2 Event.
    */
    IntegerFeature EventFrameEndSensor2Timestamp;
    /**
        \brief      EventFrameStartSensor1Timestamp
    */
    IntegerFeature EventFrameStartSensor1;
    /**
        \brief      Returns the Timestamp of the Frame Start Sensor 1 Event.
    */
    IntegerFeature EventFrameStartSensor1Timestamp;
    /**
        \brief      EventFrameStartSensor2Timestamp
    */
    IntegerFeature EventFrameStartSensor2;
    /**
        \brief      Returns the Timestamp of the Frame Start Sensor 2 Event.
    */
    IntegerFeature EventFrameStartSensor2Timestamp;
    /**
    ...
    */
    ...
    /**
        \brief      EventTriggerReadySensor1Timestamp
    */
    IntegerFeature EventTriggerReadySensor1;
    /**
        \brief      Returns the Timestamp of the Trigger Ready Sensor 1 Event.
    */
    IntegerFeature EventTriggerReadySensor1Timestamp;
    /**
        \brief      EventTriggerReadySensor2Timestamp
    */
    IntegerFeature EventTriggerReadySensor2;
    /**
        \brief      Returns the Timestamp of the Trigger Ready Sensor 2 Event.
    */
    IntegerFeature EventTriggerReadySensor2Timestamp;
    /**
        \brief      EventTriggerSkippedSensor1Timestamp
    */
    IntegerFeature EventTriggerSkippedSensor1;
    /**
        \brief      Returns the Timestamp of the Trigger Skipped Sensor 1 Event.
    */
    IntegerFeature EventTriggerSkippedSensor1Timestamp;
    /**
        \brief      EventTriggerSkippedSensor2Timestamp
    */
    IntegerFeature EventTriggerSkippedSensor2;
    /**
        \brief      Returns the Timestamp of the Trigger Skipped Sensor 2 Event.
    */
    IntegerFeature EventTriggerSkippedSensor2Timestamp;
    /**
        \brief      Returns the unique Identifier of the bo Serial Read Ready type of Event.
    */
    IntegerFeature EventboSerialReadReady;
    /**
        \brief      Returns the Timestamp of the bo Serial Read Ready Event.
    */
    IntegerFeature EventboSerialReadReadyTimestamp;
    /**
    ...
    */
    ...
    /**
        \brief      Focal power in diopters (dpt).
    */
    DoubleFeature FocalPower;
    /**
        \brief      Specifies the integer value of the Focus.
    */
    ...
    */
    ...
    /**
        \brief      Prepares the optic controller for disconnect.
    */
    CommandFeature OpticControllerDisconnect;
    /**
        \brief      Family name of the optic controller.
    */
    StringFeature OpticControllerFamilyName;
    /**
        \brief      Firmware version of the optic controller.
    */
    IntegerFeature OpticControllerFirmwareVersion;
    /**
    ...
    */
    ...
    /**
        \brief      Optic controller temperature in degrees Celsius (C).
    */
    ...
    */
    ...
    /**
        \brief      Selects the streaming channel that will be used to transfer the selected stream of data. In general, this feature can be omitted and the default streaming channel will be used.
    */
    IntegerFeature TransferStreamChannel;
    /**
    ...
    */
    ...
    /**
        \brief      The sensor format for sensor 1 is reduced to feature value pixels per line.
    */
    IntegerFeature XLengthCUTSensor1;
    /**
        \brief      The sensor format for sensor 2 is reduced to feature value pixels per line.
    */
    IntegerFeature XLengthCUTSensor2;
    /**
        \brief      The start point of pixel 0 for sensor 1 on a line. It is programmed during sensor adjustment.
    */
    IntegerFeature XStartCUTSensor1;
    /**
        \brief      The start point of pixel 0 for sensor 2 on a line. It is programmed during sensor adjustment.
    */
    IntegerFeature XStartCUTSensor2;
    /**
        \brief      The sensor format for sensor 1 is reduced to feature value lines per image.
    */
    IntegerFeature YLengthCUTSensor1;
    /**
        \brief      The sensor format for sensor 2 is reduced to feature value lines per image.
    */
    IntegerFeature YLengthCUTSensor2;
    /**
        \brief      The start point of line 0 for sensor 1 in the image. It is programmed during sensor adjustment.
    */
    IntegerFeature YStartCUTSensor1;
    /**
        \brief      The start point of line 0 for sensor 2 in the image. It is programmed during sensor adjustment.
    */
    IntegerFeature YStartCUTSensor2;
    /**
